...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FNC2] = LAYOUT_65_ansi(
        ...
        RGB_TOG, _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______,  _______,           _______, _______,
        _______,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______,  _______,  _______, _______, _______,
        _______, _______, _______,                            _______,                   _______, KC_NO,    TT(FNC2), KC_MPRV, KC_MPLY, KC_MNXT
        ),
};
/*====================================LAYERS====================================*/
