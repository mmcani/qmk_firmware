...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [GAME_BASE] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_LWIN,  LALT_LB,                             KC_SPC,                             RALT_RB,  TT(FN2),  TT(FN1),  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [FN2] = LAYOUT_ansi_67(
        ...
        _______,           _______,  _______, KC_CALC, _______, _______, _______, KC_MYCM, _______, _______,  _______,            _______, _______,
        _______, _______,  _______,                             _______,                            _______,  KC_NO,    KC_NO,  _______, _______, _______)
};
