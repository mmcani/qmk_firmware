...
#define K_MEDIA MO(RGB_MEDIA)
#define K_FUNC MO(FUNCTIONS)
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, LALT_LB,                            KC_SPACE,                            RALT_RB, K_FUNC,  KC_LEFT, KC_DOWN, KC_RIGHT
        ),
    ...
    [FUNCTIONS] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, KC_TERM, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLU,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, WN_LOCK, _______, _______,          _______, KC_VOLD,
        _______,          _______, _______, KC_CALC, _______, _______, NK_TOGG, KC_MYCM, _______, _______, _______, _______, _______,
